          ...
          <div class="col-md-8">
            ...
            <div class="post-container">
              ...
              <?php
                ...
                $sql = "SELECT p.post_id,p.title,p.description,p.category,p.post_date,p.post_img,c.category_name,u.first_name,u.last_name,p.author FROM post AS p INNER JOIN category AS c ON p.category=c.category_id INNER JOIN user_t AS u ON p.author=u.user_id ORDER BY p.numbering DESC LIMIT $offset,$limit";
                ...
                <div class="row">
                  <div class="col-md-4">
                    <a class="post-img" href="single.php">
                      <img src="image/post_1.jpg" alt="">image
                    </a>
                  </div>
                  <div class="col-md-8">
                    <div class="inner-content clearfix">
              ...
              <?php
                ...
                if($total_no_of_record > 0) {
                  ...
                  if($total_page > 1) {
                    ...
                    if($page>1) {
                      $p=$page-1;
                      echo "<a href='index.php?page=$p'>Prev</a>";
                    }
                    else {
                    ...
                    for($j=1;$j<=$total_page;$j++) {
                      if($page==$j) {
                        echo "<a class='active' href='index.php?page=$j'>$j</a>";
                      }
                      else {
                    ...
                    if($total_page>$page) {
                      $p=$page+1;
                      echo "<a href='index.php?page=$p'>Next</a>";
                    }
                    else {
